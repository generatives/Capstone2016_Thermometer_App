...
linker.cmd: package/cfg/app_ble_pem3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_pem3cfg.cmd\)\"$""\"C:/Development/Capstone/CCS_Workspace/simple_peripheral_cc2650lp_app/FlashROM/configPkg/\1\""' package/cfg/app_ble_pem3.xdl > $@
